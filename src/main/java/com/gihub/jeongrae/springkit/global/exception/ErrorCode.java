package com.gihub.jeongrae.springkit.global.exception;
...
public enum ErrorCode {
    ...
    MEMBER_NOT_FOUND("존재하지 않는 사용자입니다.", "4204_MEMBER_NOT_FOUND_ERROR"),
    // OAuth 및 토큰 오류
    ...
    INSUFFICIENT_MEMBER_PERMISSION("권한이 부족한 사용자입니다.", "4308_INSUFFICIENT_TOKEN_PERMISSION_ERROR"),
    // 메일 전송 오류
