...
/** 문서가 기대하는 HTTP 메서드, URI와 요청 파라미터 표현 */
...
/** 요청 또는 응답 본문 필드의 선택 및 문서 제외 상태 표현 */
data class Field(
    override val key: String,
    override val description: String,
    override val sample: Sample,
