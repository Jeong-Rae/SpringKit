...
- 커밋: `Feature: 프로젝트 생성 CLI 제공`

### 5. Help와 사용 예시 제공

- 지원 option, default 의미, 의존성 입력 방법을 문서화한다.
- 검증: help command가 성공하고 문서 예제 command가 실행된다.
- 커밋: `Docs: 프로젝트 생성 CLI 문서화`
