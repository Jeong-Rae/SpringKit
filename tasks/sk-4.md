...
- 커밋: `Refactor: separate planning from materialization`

### 5. 충돌 검출 추가

- 서로 양립할 수 없거나 동일 산출물을 소유한 action의 처리 규칙을 둔다.
- 검증: 충돌 plan이 실행 전에 거부되는지 테스트한다.
- 커밋: `Feature: detect generation plan conflicts`
