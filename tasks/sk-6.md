...
외부 dependency ID를 canonical metadata로 resolve하고 platform 호환성, BOM, repository 정책을 중앙에서 적용한다.
...
- 생성 contributor가 raw dependency ID를 해석하지 않는다.
- 비호환 dependency는 filesystem 변경 전에 거부된다.
